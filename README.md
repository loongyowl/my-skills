...
| wisdom-to-course | 将佛教、哲学、心理学、人际沟通等领域的智慧转化为交互式HTML学习课程。帮助用户通过互动体验提升内心觉察、情绪管理和行为有效性。当用户想要学习情绪管理、改善人际... | MIT |
| xlsx | Use this skill for spreadsheet operations: create, edit, analyze Excel files wit... | Proprietary |

## Installation

Use the CLI tool to search and install skills:
```bash
# Search for a skill
skills-cli search <keyword>

# Install a skill
skills-cli install <skill-name>
```